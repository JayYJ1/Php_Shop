...
<?php
   ...
   $cookie_name=$_COOKIE['cookie_name'];
	$query = "select * from member where no37 = $no;";
...
<table width="600" border="1" cellpadding="2"  style="border-collapse:collapse">
	<tr height="20"> 
		...
		<td width="500" bgcolor="#F2F2F2"><?=$row['uid37']?></td>
	</tr>
	<tr height="20"> 
		<td width="100" align="center" bgcolor="#CCCCCC">암호</td>
		<td width="500" bgcolor="#F2F2F2">
			<input type="text" name="pwd" value="<?=$row['pwd37']?>" size="20" maxlength="20">
		</td>
	</tr>
	<tr height="20"> 
		<td width="100" align="center" bgcolor="#CCCCCC">이름</td>
		<td width="500" bgcolor="#F2F2F2">
			<input type="text" name="name" value="<?=$row['name37']?>" size="20" maxlength="20">
		</td>
	</tr>
	<tr height="20"> 
	...
	<tr height="20"> 
		...
		<td width="500" bgcolor="#F2F2F2">
			<input type="text" name="email" value="<?=$row['email37']?>" size="40" maxlength="40">
		</td>
	</tr>
	<tr height="20"> 
		<td width="100" align="center" bgcolor="#CCCCCC">주소</td>
		<td width="500" bgcolor="#F2F2F2">
			<input type="text" name="zip" value="<?=$row['zip37']?>" size="5" maxlength="5"> &nbsp 
			<input type="button" value="우편번호 찾기" onClick="javascript:OpenWinZip(0);"> <br>
			<input type="text" name="juso" value="<?=$row['juso37']?>" size="60" maxlength="100">
		</td>
	</tr>
	<tr height="20"> 
	...
	<td>
	<input type="hidden" name="cookie_no" value="<?=$cookie_no?>">
	</td>
	</tr>
</table>
<br>
